    ...
    <div className="coding-class my-5   ">
      <div className=" container px-4   ">
        ...
        <div className="skill-parent  col">
            ...
            <div className="skill1" data-aos="fade-down">
              ...
              <div className="progress">
                <div
                  ...
                  role="progressbar"
                  style={{ width: "85%", backgroundColor: "#B1F6CA" }}
                  aria-valuenow="25"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
            ...
            <div className="skill2" data-aos="fade-down">
              ...
              <div className="progress">
                <div
                  className="progress-bar"
                  role="progressbar"
                  style={{ width: "90%", backgroundColor: "#B1F6CA" }}
                  aria-valuenow="25"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
            ...
            <div className="skill3" data-aos="fade-down">
              ...
              <div className="progress">
                <div
                  className="progress-bar"
                  role="progressbar"
                  style={{ width: "50%", backgroundColor: "#B1F6CA" }}
                  aria-valuenow="25"
                  aria-valuemin="0"
                  aria-valuemax="100"
                >
          ...
          <div className="h1 text-left mt-5 col2-text row  d-flex justify-content-center align-items-center  ">
            My Stats
            <hr className="hr hr-blurry" />
            <div className="row d-flex justify-content-center align-items-center ">
              <div
                className="card mb-3 col-sm stats-mainLayer   "
                data-aos="zoom-in"
              >
                <div className="row g-0  w-100 stats-body   ">
                    ...
                    <div className="chk ">
                      <div className="circlechk">
                        <img
                          ...
                          onClick={() => {
                            window.open(
                              "https://leetcode.com/mangleshkumar665/"
                            );
                          }}
                        />
                      </div>
                  ...
                  <div className="col-md-8   stats-info">
                    <div className="card-body  ">
                      <h5 className="card-title  stats-superChild">
                        Problems Solved
                      </h5>
                    ...
                    <div className="chk ">
                      <div className="circlechk">
                        <img
                          ...
                          onClick={() => {
                            window.open(
                              "https://www.hackerrank.com/2001640100150_2C"
                            );
                          }}
                        />
                      </div>
                    ...
                    <div className="card-body">
                      ...
                      <div className="col-md-4 d-flex justify-content-center align-items-center ">
                        <div className="row" data-aos="fade-up">
                          <div className="col" style={{ fontSize: "1.8rem" }}>
                            {" "}
                            5 <img src={star}style={{width:"25px" , marginTop:"-5px"}} alt="stars"></img>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="chk ">
                      <div className="circlechk">
                        <img
                          ...
                          onClick={() => {
                            window.open(
                              "https://www.codechef.com/users/mangleshkumar"
                            );
                          }}
                        />
                      </div>
                  ...
                  <div className="col-md-8">
                    <div className="card-body">
                      ...
                      <div
                        ...
                        data-aos="fade-up"
                      >
                        <div style={{ fontSize: "1.5rem" }}>3rd Div</div>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className=" ">
          <div className="projects-title">
            <div className="h1 text-left mt-5 col2-text ">
              My Projects
              <hr className="hr hr-blurry" />
            </div>
          </div>
              ...
              <div className="card projects-cardImg   " data-aos="fade-right">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text mt-1">
                    To-do list is app that lists your tasks that you have to do,
            ...
            <div className="col  d-flex justify-content-center ">
              <div className="card projects-cardImg " data-aos="fade-up">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text mt-1">
                    A simple GUI Calculator which performs Basic maths
                    calculations{" "}
                  </p>
                </div>
              </div>
            ...
            <div className="col d-flex justify-content-center">
              <div className="card projects-cardImg " data-aos="fade-up">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text mt-1">
                    Type^2 is a Typing speed analyser thorugh which you can get
                    your WPM and Correctness{" "}
                  </p>
                </div>
              </div>
            </div>
